...
const Submissions = () => {
  ...
  const [que4, setQue4] = useState([{ id: 1, time: "00:00", progress: 70 }]);
        ...
        <div className="que-preview" key={que1.id}>
          {que1.id !== 0 && (
            <SubCard
              attemptNo={que1.id}
              time={que1.time}
              progbar={<ProgressBar animated now={que1.progress} />}
            />
          )}
        </div>
      ))}
        ...
        <div className="que-preview" key={que2.id}>
          {que2.id !== 0 && (
            <SubCard
              attemptNo={que2.id}
              time={que2.time}
              progbar={<ProgressBar animated now={que2.progress} />}
            />
          )}
        </div>
      ))}
        ...
        <div className="que-preview" key={que3.id}>
          {que3.id !== 0 && (
            <SubCard
              attemptNo={que3.id}
              time={que3.time}
              progbar={<ProgressBar animated now={que3.progress} />}
            />
          )}
        </div>
      ))}
        ...
        <div className="que-preview" key={que4.id}>
          {que4.id !== 0 && (
            <SubCard
              attemptNo={que4.id}
              time={que4.time}
              progbar={<ProgressBar animated now={que4.progress} />}
            />
          )}
        </div>
      ))}
        ...
        <div className="que-preview" key={que5.id}>
          {que5.id !== 0 && (
            <SubCard
              attemptNo={que5.id}
              time={que5.time}
              progbar={<ProgressBar animated now={que5.progress} />}
            />
          )}
        </div>
      ))}
        ...
        <div className="que-preview" key={que6.id}>
          {que6.id !== 0 && (
            <SubCard
              attemptNo={que6.id}
              time={que6.time}
              progbar={<ProgressBar animated now={que6.progress} />}
            />
          )}
        </div>
      ))}
